...
var slide = window.pageYOffset; function move(){
    ...
    var nav = document.querySelector('#banner');
    if(slide > newSlide){ nav.style.top = '-20.6em'} else{ nav.style.top = '0em'; document.querySelector('button')} slide = newSlide} 
var a = document.querySelectorAll('li a'); a.onclick = function(){move()}
